    ...
    return <section id="contact" className="min-h-screen flex items-center justify-center py-20 ">
        <RevealOnScroll>
            <div className="px-4 w-150 ">
                ...
                <a href="mailto:shreyapoojary251@gmail.com" className="flex justify-center   border border-white/10 rounded  py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-5500/5  bg-blue-500">shreyapoojary251@gmail.com</a>
